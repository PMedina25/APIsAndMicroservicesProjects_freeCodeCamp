...
mongoose.connect('mongodb+srv://strider:qAFu0zifL1kPeqAv@cluster0.m9yxb.mongodb.net/freecodecamp?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true }); 
...
var createAndSavePerson = function(done) {
  let person = new Person({
    name: "Pablo",
    age: 24,
    favoriteFoods: ["macarroni", "lassagna", "spaghetti"]
  });
